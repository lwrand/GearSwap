...
function user_setup()
	...
	gear.rng_nuke_head={ name="Herculean Helm", augments={'STR+4','Weapon skill damage +3%','Accuracy+2 Attack+2','Mag. Acc.+20 "Mag.Atk.Bns."+20',}}
	gear.rng_nuke_feet={ name="Herculean Boots", augments={'Accuracy+25 Attack+25','"Store TP"+3','Accuracy+7',}}
		
	gear.tp_ranger_jse_back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Rng.Acc.+10','"Snapshot"+10',}}
	gear.wsd_ranger_jse_back={ name="Belenus's Cape", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Rng.Atk.+10','Weapon skill damage +10%',}}
	...
	send_command('bind !c gs c weapons MagicWeapons;gs c update')
...
function init_gear_sets()
    ...
    sets.precast.WS.Acc = {
		...
		neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Telos Earring",
    ...
    sets.precast.WS['Wildfire'] = {
        head=gear.rng_nuke_head,
		body="Meg. Cuirie +2",
		hands="Carmine Fin. Ga. +1",
		legs="Gyve Trousers",
		feet=gear.rng_nuke_feet,
    ...
    sets.precast.WS['Wildfire'].Acc = {
        head=gear.rng_nuke_head,neck="Sanctity Necklace",ear1="Crematio Earring",ear2="Friomisi Earring",
