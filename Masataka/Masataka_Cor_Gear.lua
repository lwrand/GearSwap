...
function user_setup()
	...
	gear.cor_nuke_head={ name="Herculean Helm", augments={'STR+4','Weapon skill damage +3%','Accuracy+2 Attack+2','Mag. Acc.+20 "Mag.Atk.Bns."+20',}}
	gear.cor_nuke_legs={ name="Herculean Trousers", augments={'Attack+5','"Avatar perpetuation cost" -1','Accuracy+15 Attack+15','Mag. Acc.+20 "Mag.Atk.Bns."+20',}}
	gear.cor_nuke_feet={ name="Herculean Boots", augments={'Accuracy+25 Attack+25','"Store TP"+3','Accuracy+7',}}
	...
	send_command('bind !f gs c weapons DualSavageWeapons;gs c update')
...
function init_gear_sets()
    ...
    sets.precast.WS['Leaden Salute'] = {
		...
		waist="Eschan Stone",
		--legs="Laksa. Trews +3",
		legs=gear.cor_nuke_legs,
		--feet="Lanun Bottes +3"
		feet=gear.cor_nuke_feet
	}
