...
function init_gear_sets()
    ...
    sets.precast.FC = {main={ name="Grioavolr", augments={'Enfb.mag. skill +14','MND+10','Mag. Acc.+22','"Mag.Atk.Bns."+4',}},
    ammo="Impatiens",
    ...
    back={ name="Mecisto. Mantle", augments={'Cap. Point+47%','INT+2','"Mag.Atk.Bns."+2','DEF+4',}}}
		
    sets.precast.FC.DT = {main={ name="Grioavolr", augments={'Enfb.mag. skill +14','MND+10','Mag. Acc.+22','"Mag.Atk.Bns."+4',}},
    ammo="Impatiens",
    head="Inyanga Tiara +2",
    body="Shango Robe",
    hands="Inyan. Dastanas +2",
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC['Healing Magic'], {feet="Hygieia Clogs"},{head="Piety Cap +1"},{back="Pahtli cape"})
	...
	sets.ConserveMP = {main={ name="Rubicundity", augments={'Mag. Acc.+3','"Mag.Atk.Bns."+3','Dark magic skill +5','"Conserve MP"+2',}},
    ammo="Pemphredo Tathlum",
    body={ name="Witching Robe", augments={'MP+50','Mag. Acc.+15','"Mag.Atk.Bns."+15','"Refresh"+1',}},
    hands={ name="Fanatic Gloves", augments={'MP+5','"Conserve MP"+2',}},
    feet="Regal Pumps +1"}
	...
	sets.midcast['Erase'] = set_combine(sets.midcast.FastRecast,{main="Yagrush";neck="Cleric's Torque"})
	...
	sets.midcast.LightDayCureSolace = {main="Chatoyant Staff",
    ammo="Pemphredo Tathlum",
    head="Ebers Cap +1",
    body="Ebers Bliaud +1",
    hands={ name="Kaykaus Cuffs", augments={'MP+60','MND+10','Mag. Acc.+15',}},
	...
	sets.midcast.LightDayCure = {main="Chatoyant Staff",
    ammo="Pemphredo Tathlum",
    head="Ebers Cap +1",
    body="Ebers Bliaud +1",
    hands={ name="Kaykaus Cuffs", augments={'MP+60','MND+10','Mag. Acc.+15',}},
	...
	sets.midcast.LightWeatherCuraga = {main={ name="Queller Rod", augments={'Healing magic skill +15','"Cure" potency +10%','"Cure" spellcasting time -7%',}},
    sub="Sors Shield",
    ammo="Pemphredo Tathlum",
    head="Ebers Cap +1",
    body="Theo. Briault +1",
	...
	sets.midcast.LightDayCuraga = {main={ name="Queller Rod", augments={'Healing magic skill +15','"Cure" potency +10%','"Cure" spellcasting time -7%',}},
    sub="Sors Shield",
    ammo="Pemphredo Tathlum",
    head="Ebers Cap +1",
    body="Theo. Briault +1",
	...
	sets.midcast.Cure.DT = {main={ name="Queller Rod", augments={'Healing magic skill +15','"Cure" potency +10%','"Cure" spellcasting time -7%',}},
    sub="Sors Shield",
    ammo="Pemphredo Tathlum",
    head="Ebers Cap +1",
    body="Theo. Briault +1",
	...
	sets.midcast.Cursna = {main="Yagrush",sub="Clemency Grip",ammo="Hasty Pinion +1",
	...
	sets.midcast.StatusRemoval = {main="Yagrush",sub="Clemency Grip",ammo="Hasty Pinion +1",
	...
	sets.midcast['Enhancing Magic'] = {main={ name="Serenity", augments={'MP+15','Enha.mag. skill +3','"Cure" potency +2%',}},
    head="Befouled Crown",
    hands="Inyan. Dastanas +2",
	...
	sets.midcast.Regen = set_combine(sets.midcast['Enhancing Magic'], {body="Piety Briault +3",hands="Ebers Mitts +1",legs="Th. Pant. +2",})
	...
	sets.midcast['Enfeebling Magic'] = {main={ name="Grioavolr", augments={'Enfb.mag. skill +14','MND+10','Mag. Acc.+22','"Mag.Atk.Bns."+4',}},
    sub="Mephitis Grip",
    ammo="Kalboron Stone",
    head="Befouled Crown",
    body="Shango Robe",
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main={ name="Grioavolr", augments={'Enfb.mag. skill +14','MND+10','Mag. Acc.+22','"Mag.Atk.Bns."+4',}},
    sub="Mephitis Grip",
    ammo="Kalboron Stone",
    head="Befouled Crown",
    body="Shango Robe",
