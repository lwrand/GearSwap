...
function init_gear_sets()
    ...
    sets.precast.WS['Myrkr'] = {ammo="Sancus Sachet +1",
        ...
        body="Convoker's Doublet +3",hands="Regal Cuffs",ring1="Mephitas's Ring +1",ring2="Mephitas's Ring",
    ...
    sets.idle.Avatar = {
		...
		sub = "Oneiros Grip", -- (+1 refresh when mp<75%) ok
		ammo = "Sancus Sachet +1", -- (avatar lvl 119)
		head = "Beckoner's Horn +1", -- (+2 refresh and avatar flavor +3) ok
		neck = "Caller's Pendant", -- (avatar regain +25) ok
		ear2 = "Moonshade Earring", -- (+1 refresh)
		ear1 = "Andoaa Earring", -- (+5 summoning skill)
		body = "Shomonjijoe +1", -- (+3 refresh, +14 avatar enmity)
		hands = "Asteria Mitts +1", -- (+1-2 refresh)
		ring1 = "Evoker's Ring", -- (-1 perp, +10 summoning skill)
		ring2 = "Stikini Ring", -- (+5 summoning skill)
		back = "Campestres's Cape", -- (+1 avatar lvl) ok
		waist = "Lucidity Sash", -- (-2 perp, +7 summoning skill)
		legs = "Assid. Pants +1", -- (-3 perp, +1-2 refresh) ok
