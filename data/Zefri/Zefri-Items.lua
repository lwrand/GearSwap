...
gear.merlinic_nuke_feet = {name="Merlinic Crackows",augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','Magic Damage +15','MND+4','"Mag.Atk.Bns."+13',}}
...
gear.merlinic_refresh_feet = {name="Merlinic Crackows",augments={'"Waltz" potency +6%','DEX+2','"Refresh"+2','Accuracy+6 Attack+6','Mag. Acc.+15 "Mag.Atk.Bns."+15',}}
