...
function user_setup()
	...
	state.OffenseMode:options('Normal','MinAcc','SomeAcc','Acc','HighAcc','FullAcc','Fodder')
...
function init_gear_sets()
	...
	sets.precast.WS['Requiescat'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Jhakri Coronal +2",
		ear1="Mache Earring",
		ear2="Brutal Earring",
		body="Jhakri Robe +2",
		ring2="Rufescent Ring",
	...
	sets.precast.WS['Requiescat'].Acc = set_combine(sets.precast.WS.Acc, {head="Jhakri Coronal +2",
		ear1="Regal Earring",
		ear2="Telos Earring",
	...
	sets.precast.WS['Realmrazer'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Jhakri Coronal +2",
		ear1="Regal Earring",
		ear2="Telos Earring",
		body="Jhakri Robe +2",
		ring2="Rufescent Ring",
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {
		...
		--feet={name="Herculean Boots", augments={'Accuracy+21','Crit. hit damage +4%','Attack+3',}}
	})
	...
	sets.midcast['Blue Magic'].Healing = {main="Nibiru Cudgel",
		sub="Nibiru Cudgel",
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {
		legs={ name="Herculean Trousers", augments={'"Repair" potency +2%','Sklchn.dmg.+3%','"Treasure Hunter"+1','Accuracy+15 Attack+15','Mag. Acc.+12 "Mag.Atk.Bns."+12',}},
		feet={ name="Herculean Boots", augments={'DEX+2','Pet: INT+9','"Treasure Hunter"+2',}}
	})
	...
	sets.engaged = {
		...
		legs="Samnuha Tights",
		feet={ name="Herculean Boots", augments={'Accuracy+18 Attack+18','"Triple Atk."+3',}},
		ear2="Cessance Earring",
