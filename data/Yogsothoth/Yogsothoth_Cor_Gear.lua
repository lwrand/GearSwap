...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {
		...
		ring2="Dark Ring",
        back=gear.tp_jse_back,waist="Flume Belt",
    ...
    sets.precast.FC = {
        head="Carmine Mask",neck="Baetyl Pendant",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
    ...
    sets.precast.RA = {ammo=gear.RAbullet,
		...
		waist="Impulse Belt",
		legs=gear.adhemar_tp_legs,
		feet="Meg. Jam. +2"}
		
	sets.precast.RA.Flurry = set_combine(sets.precast.RA, {body="Laksa. Frac +3"})
	sets.precast.RA.Flurry2 = set_combine(sets.precast.RA, {"Chass. Tricorne +1"})
    ...
    sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {head="Carmine Mask",ring2="Rufescent Ring",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"})
    ...
    sets.precast.WS['Leaden Salute'].Acc = {ammo=gear.MAbullet,
        ...
        body="Lanun Frac +3",hands="Leyline Gloves",ring1="Archon Ring",ring2="Dingir Ring",
	...
	sets.buff['Triple Shot'] = {body="Chasseur's Frac +1", head="Oshosi Mask"}
    ...
    sets.idle = {ammo=gear.RAbullet,
        ...
        body="Meg. Cuirie +2",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Dark Ring",
        back="Mecistopins mantle ",waist="Flume Belt",legs="Carmine Cuisses +1",feet=gear.herculean_dt_feet}
	...
	sets.weapons.LeadenWeapons = {main="Hepatizon rapier +1",sub="Fettering Blade",range="Fomalhaut"}
    ...
    sets.engaged = {
		...
		hands=gear.adhemar_tp_dw_hands,
		ring1="Epona's Ring",
		ring2="Petrov Ring",
		back=gear.tp_jse_back,
		waist="Kentarch belt +1",
		legs="Samnuha Tights",
		feet=gear.adhemar_tp_feet}
