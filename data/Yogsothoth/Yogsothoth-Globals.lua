...
send_command('bind ^j gs c weapons Default') --Requips weapons and gear.
...
send_command('bind ^h gs c cycle treasuremode') --Toggles hitting htings with your treasure hunter set.
